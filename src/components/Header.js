...
const Header = () => {
  ...
  const isActive = (path, location) => !!(path === location.pathName);

  return (
    <header className='fixed w-full px-[30px] lg:px-[100px] h-[100px] lg:h-[120px] flex items-center z-30 hover:bg-[#eef7f9] transition-all duration-500'>
